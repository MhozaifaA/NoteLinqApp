...
namespace Meteors.AspNetCore.Infrastructure.EntityFramework.Context
{
    public interface IMrIdentityDbContext<TKey>: IDisposable  where TKey :struct, IEquatable<TKey> 
    {
        ...
        TransferredProp CurrentTransferredProps { get; }
        ...
        EntityEntry<TEntity> AddWithTranslate<TEntity>(TEntity entity) where TEntity : class, IBaseEntity<TKey>;
        Task<EntityEntry<TEntity>> AddWithTranslateAsync<TEntity>(TEntity entity) where TEntity : class, IBaseEntity<TKey>;
        ...
        EntityEntry<TEntity> Translate<TEntity>(TEntity entity) where TEntity : class, IBaseEntity<TKey>;
        Task<EntityEntry<TEntity>> TranslateAsync<TEntity>(TEntity entity) where TEntity : class, IBaseEntity<TKey>;
