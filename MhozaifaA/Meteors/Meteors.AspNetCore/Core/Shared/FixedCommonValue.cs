...
namespace Meteors.AspNetCore.Core.Shared
{
    public class CommonValue
    {
        public const string SolitaryRoute = "~/";
        public const string SolitaryApiRoute = FixedCommonValue.SolitaryRoute + FixedCommonValue.API;
    }

    internal class FixedCommonValue
    {
        /// <summary>
        /// Constant repo name.
        /// </summary>
