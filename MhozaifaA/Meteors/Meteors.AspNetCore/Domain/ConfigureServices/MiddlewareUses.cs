...
namespace Meteors.AspNetCore.Domain.ConfigureServices
{
    ...
    public static class MiddlewareUses
    {
        ...
        /// <param name="context"> as return scope inject of <see cref="DbContext"/></param>
        /// <returns> <see cref="IApplicationBuilder"/> </returns>
        public static IApplicationBuilder UseDbContextSeed<T>(this IApplicationBuilder builder, Action<T, IServiceProvider> context) where T : DbContext
        {
            ServiceScope = builder.CreateFactoryScope();
        ...
        /// </summary>
        /// <param name="builder"></param>
        public static void DisposeDbContextSeed(this IApplicationBuilder builder)
        => ServiceScope.Dispose();
    }
}
