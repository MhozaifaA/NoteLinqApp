using NoteLinqApp.DataTransferObjects;
...
namespace NoteLinqApp.BoundedContext.Repositories.Security
{

    [AutoService]
    public class AccountRepository : MrRepository<NoteLinqAppInMemoryDbContext, Guid, Account>, IAccountRepository
    {
        private readonly UserManager<Account> UserManager;
        private readonly SignInManager<Account> SignInManager;
        private readonly IConfiguration Configuration;

        public AccountRepository(NoteLinqAppInMemoryDbContext context,UserManager<Account> userManager,
