...
using NoteLinqApp.Core.SwaggerEasySummary.Configure;
    ...
    public static class SWSwaggerGenServiceCollectionExtensions
    {
            ...
            this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "2.0",
                    Title ="NoteLinq App" ,//Assembly.GetEntryAssembly().GetName().Name,
                    Description = "API for " + Assembly.GetEntryAssembly().GetName().Name,
                    TermsOfService = new Uri("https://norlinq.com/"),
                    Contact = new OpenApiContact
                    {
                        Name = "Contact",
                        Url = new Uri("https://norlinq.com/")
                    },
